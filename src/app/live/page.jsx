  ...
  return (
    <main className="w-full">
      <div className="w-full relative">
        <Header />
        <h2 className="text-2xl font-bold mt-10 lg:px-20">
          Khang ơi, chào mừng bạn quay lại!
        </h2>
        <p className="mt-1 lg:px-20">Chọn cách bạn muốn phát trực tiếp.</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10 lg:px-20">
          <div className="bg-white p-4 rounded-md flex flex-col justify-between h-[400px] hover:border-blue-700 border-2">
            <div>
              ...
              <div className="flex items-start gap-x-3">
                ...
                <div>Phát trực tiếp một mình hoặc cùng với người khác</div>
              </div>
              <div className="flex items-start my-4 gap-x-3">
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <div>Chọn nơi đăng video trực tiếp</div>
              </div>
              <div className="flex items-start gap-x-3">
                <div>
                  <svg
                ...
                <div>Khám phá thêm công cụ để thu hút người xem</div>
              </div>
            </div>
            <button className="mt-4 w-full bg-blue-200 text-blue-700 p-1.5 rounded-md hover:bg-blue-400">
              Phát trực tiếp
            </button>
          </div>
          <div className="bg-white p-4 rounded-md flex flex-col justify-between h-[400px] hover:border-blue-700 border-2">
            <div>
              ...
              <div className="flex items-start gap-x-3">
                ...
                <div>Tạo trước một sự kiện để chia sẻ với đối tượng</div>
              </div>
              <div className="flex items-start my-4 gap-x-3">
                <div>
                  <svg
