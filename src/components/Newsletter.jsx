  ...
  if (isFixed) {
        ...
        <div class={`bg-white w-[280px] rounded-md mt-2`}>
          <div class="py-4 px-4">
            <div class="text-center">
              <h3 class="mb-4 text-base font-bold text-gray-900 sm:text-2xl">
                CÁC BÀI VIẾT NỔI BẬT BẠN KHÔNG NÊN BỎ LỠ!
              </h3>
              <p class="mb-8 max-w-2xl font-light text-gray-500 md:mb-12 sm:text-lg dark:text-gray-400">
                ...
                <div class="items-center mb-3 space-y-4 flex-col">
                  ...
                  <div>
                    <button
                      onClick={onSubmit}
                      type="button"
                      className="w-full px-5 py-3 text-sm font-medium text-center text-white rounded-lg cursor-pointer bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300"
                    >
                      Đăng ký!
                    </button>
                  </div>
    ...
    return (
      <div className="sticky top-0">
        <div
          class={`bg-white ${isLeft ? "w-full" : "w-[280px]"}  mt-4 rounded-md`}
        >
          <div class="py-4 px-4">
            ...
            <p class="mb-8 text-xs font-normal text-center">
              Thứ Năm hàng tuần, DuMuc sẽ gửi bạn email tổng hợp những bài viết
