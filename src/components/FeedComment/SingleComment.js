        ...
        <div className="text-sm text-gray-500 flex items-center gap-2 mt-[5px]">
          ...
          <div className="relative cursor-pointer group flex items-center">
            ...
            <Link 
              ...
              <Link 
                ...
                onClick={(e) => {
                  ...
                  if(!user){
                    ...
                    if(qoute?.find(x => x.commentId === item.commentId)){
                      message.warning("Bạn đã trích dẫn bình luận này rồi")
                    }else{
                      let newArr = qoute || [];
                      newArr?.push(item)
                      setQoute([...newArr])
              ...
              >
                {
                  qoute?.find(x => x.commentId === item.commentId) ? "Đã trích dẫn" : "Trích dẫn"
                }
              </Link>
