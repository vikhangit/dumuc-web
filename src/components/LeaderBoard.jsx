      ...
      {title && (
        <h3 class="mb-3 px-0 xl:px-2 text-base font-bold text-gray-900 flex items-center">
          <svg
            ...
            fill="currentColor"
            class="w-6 h-6 text-gray-800 mr-1.5"
            strokeWidth={3}
            viewBox="0 0 24 24"
          >
            {" "}
            <path fill="none" strokeWidth={3} d="M0 0h24v24H0z" />{" "}
                ...
                <div class="flex items-center basis-1/3 sm:basis-1/4 md:basis-1/5">
                  <div
                    className={`flex items-center justify-center ${
                      index >= 3
                        ? "w-12 h-12 xl:w-10 xl:h-10 mr-2 rounded-md bg-white rounded-lg shadow-sm shadow-gray-300"
                        : "w-14 h-14 xl:w-12 xl:h-12"
                    }`}
                  >
                    {index < 3 ? (
                      <Image
                ...
                <div className="basis-2/3 sm:basis-3/4 md:basis-4/5 flex justify-between items-center md:flex-1 md:min-w-0 text-base text-gray-900 rounded-md bg-white rounded-md py-1.5 px-3 xl:p-0 shadow-sm shadow-gray-300 xl:shadow-none">
                  <div className="w-full flex justify-between items-center">
                    <div className="flex flex-col">
                      <div className="font-medium break-all leading-none">
                        {item?.name}
                      </div>
                    ...
                    <div className="text-[#c80000] text-sm font-medium mr-2">
                      +{item?.rankingValue}
                    </div>
                  </div>
                </div>
