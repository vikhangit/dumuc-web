...
const FeedCommentReplyModal = ({ visible, setIsCommentModal, onCreateReply, onCancel, replyToName, commentId, onCallback }) => {

  const [user, loading1, errorAuth] = useAuthState(auth);
