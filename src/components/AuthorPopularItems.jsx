...
const AuthorPopularItems = ({ items, tiltle = 'THÀNH VIÊN NỔI BẬT', limit = 5 }) => {
  return (
    <div className="bg-white">
      {tiltle && (
        <h3 class="mb-3 px-4 text-base font-bold text-gray-900 flex">
          <svg class="w-5 h-5 text-gray-800 mr-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 21 20">
            ...
            >
              <div class="flex items-center gap-x-4 py-3 px-4">
                ...
                <div className="md:flex-1 md:min-w-0 text-sm font-medium text-gray-900">
                  ...
                  <div className="line-clamp-2 text-xs font-normal">{item?.description}</div>
                </div>
              </div>
            </Link>
          );
