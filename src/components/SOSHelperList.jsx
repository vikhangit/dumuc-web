                    ...
                    <div className="flex justify-between tool-sos">
                      <div className="py-2 px-1">
                        <Timer
                          ...
                          center={true}
                        />
                        <div className="text-gray-500 text-xs mt-2 tool-sos-center">
                      ...
                      <div className="text-center">
                        {item?.helper?.isCompleted && (
                          <>
                            <div className="text-blue-800 flex text-center font-bold text-xs mt-4 ml-1 hover:scale-105 transition-all cursor-pointer tool-sos-text">
                              <svg
                        ...
                        {item?.helper?.isCancelled && (
                          <>
                            ...
                            <div className="text-gray-500 text-xs mt-2">
                              {moment(item?.cancelledAt).fromNow()}
                            </div>
                          </>
                        )}

                        {item?.helper?.isCancelled !== true &&
                          item?.helper?.isCompleted !== true && (
                            <>
                              <div
                              ...
                              <div
                                ...
                                onClick={() =>
                                  onCancelled(item, user?.accessToken)
                                }
                              >
                                Huỷ giúp đỡ
                              </div>
