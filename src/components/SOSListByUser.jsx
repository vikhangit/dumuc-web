                        ...
                        <button
                          ...
                          onClick={() => {
                            Modal.confirm({
                              ...
                              content:
                                "Bạn có chắc chắn muốn huỷ S.O.S này không?",
                              onOk() {
                                cancelSos(
                                  {
                                    sosId: item?.sosId,
                                  ...
                                  .then((result) => {
                                    ...
                                    onCallback();
                                    router.push(
                                      "/account/library?tab=mysos&status=-1"
                                    );
                                  })
                                  .catch((error) => {
                                    console.error(error);
                                    ...
                                    auth.onAuthStateChanged(
                                      async (currentUser) => {
                                        if (currentUser) {
                                          ...
                                          generateCustomToken(token).then(
                                            (result) => {
                                      ...
                                      async (currentUser) => {
                                        if (currentUser) {
                                          ...
                                          generateCustomToken(token).then(
                                            (result) => {
                                              window.open(
                                                `${process.env.NEXT_PUBLIC_COMMUNICAION_URL}/call/${result?.token}`,
                                                "_blank"
                                              );
                                            }
                                          );
