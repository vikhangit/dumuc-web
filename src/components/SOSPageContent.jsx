      ...
      try {
        if (coordinates.lat && coordinates.lng) {
          ...
          let sossFilter = sossOriginal.filter((item) => {
            ...
            if (
              (item?.category?.categoryId === category ||
                category === "" ||
                category === undefined) &&
  ...
  const onClickSos = async (item) => {
    ...
    await firestore
      ...
      .then((doc) => {
        ...
        if (lastLoggedIn) {
          setLastLoggedIn(moment(lastLoggedIn.toDate()).fromNow());
        } else {
          setLastLoggedIn("");
        }
      });
  ...
  const Status1 = ({ detail }) => {
    return (
      <div
        ...
        className={`${
          !detail &&
          `absolute top-1/3 sm:top-1/2 -rotate-[15deg] -translate-y-1/3 sm:-translate-y-1/2 translate-x-1/2 ${
            sizes.width > 450 ? "right-1/3 xl:right-1/2" : "right-[40%]"
          }`
        } ${detail ? "text-sm sm:text-base md:text-lg" : "text-lg"}  ${
          sizes.width > 376
            ? "w-[160px] md:w-[200px] h-[48px]"
            : "w-fit px-5 h-[40px] text-xs text-center"
        }  font-semibold flex justify-center items-center text-[#11F10D]`}
      >
        Mới gửi
      </div>
    );
      ...
      <div
        ...
        className={`${
          ...
          sizes.width > 376
            ? "w-[160px] md:w-[200px] h-[48px]"
            : "w-fit px-5 h-[40px] text-xs text-center"
        } font-semibold flex justify-center items-center text-[#C82027]`}
      >
        Đang hỗ trợ
      </div>
    );
      ...
      <div
        ...
        className={`${
          ...
          sizes.width > 376
            ? "w-[160px] md:w-[200px] h-[48px]"
            : "w-fit px-5 h-[40px] text-xs text-center"
        } font-semibold flex justify-center items-center text-[#0F78DA]`}
      >
        Hoàn thành
      </div>
    );
      ...
      <div
        ...
        className={`${
          ...
          sizes.width > 376
            ? "w-[160px] md:w-[200px] h-[48px]"
            : "w-fit px-5 h-[40px] text-xs text-center"
        } font-semibold flex justify-center items-center text-[#5E666D]`}
      >
        Hết hạn
      </div>
    );
                            ...
                            <div>
                              <div className="flex text-gray-500 items-center gap-x-2 text-[#919191]">
                                <svg
                                  ...
                                  strokeWidth={1.5}
                                  stroke="currentColor"
                                  className="w-4 h-4 sm:w-6 sm:h-6 text-[#919191]"
                                >
                                  <path
                                    strokeLinecap="round"
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  {item?.address_components ? (
                                    <>
                                      {item?.address_components[2]
                                        ?.short_name || ""}{" "}
                                      -{" "}
                                      {item?.address_components[3]
                                        ?.short_name || ""}
                                    </>
                                  ) : (
            ...
            <div className="px-4">
              {loadingFetch === false ? (
                ...
                soss.filter(
                  ...
                  soss
                    .filter((x) => x?.helpers?.length > 0 && x?.status === 0)
                    .map((item, index) => {
                      return (
                        <div
                          key={index}
          ...
          <Modal.Body className="px-4 py-0 pb-6">
            {user ? (
              <div className="space-y-1">
                <div
                  className={`py-4 px-0 sm:px-4 text-gray-500 border-b-2 border-dashed border-[#c80000] ${
                    sizes.width > 376 ? "text-sm sm:text-base" : "text-xs"
                  }`}
                >
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <div>
                        Số xe:{" "}
                        <strong>
                          {sos?.numberPlate && sos?.numberPlate?.length > 0
                            ? sos?.numberPlate
                            : "Chưa có"}
                        </strong>
                      </div>
                      <div className="flex text-gray-500 items-center gap-x-1 mt-1">
                        <svg
                          ...
                          stroke="currentColor"
                          className={`${
                            sizes.width > 376 ? "w-6 h-6" : "w-4 h-4"
                          } `}
                        >
                          <path
                            strokeLinecap="round"
                    ...
                    <div className="">
                      ...
                      now.isAfter(
                        moment(
                          DateTimeLog(sos?.createdAt, sos?.deadline),
                          "DD/MM/YYYY hh:mm:ss"
                        )
                      ) ? (
                        <Status3 detail={true} />
                  ...
                  <div
                    className={`flex items-center line-clamp-1 ${
                      sos?.livestream_link ? "text-[#919191]" : "text-[#c80000]"
                    }  gap-x-2 mt-2`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      ...
                      strokeWidth={1.5}
                      stroke="currentColor"
                      className={`${sizes.width > 376 ? "w-6 h-6" : "w-4 h-4"}`}
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    ...
                    >
                      {sos?.livestream_link || "Chưa có link livestream"}
                    </div>
                  </div>
                </div>
                {sos?.address_components ? (
                  <div
                    className={`py-3  px-0 sm:px-4 flex text-gray-500 justify-between items-center ${
                      sizes.width > 376 ? "text-sm sm:text-base" : "text-xs"
                    }`}
                  >
                    <div className="flex flex-col gap-y-1 items-start w-[calc(100%-105px)]">
                      <div>
                        Tỉnh/ thành:{" "}
                        <strong>
                          {sos?.address_components[3]?.short_name}
                        </strong>
                      </div>
                      <div>
                        Quận/ huyện:{" "}
                        <strong>
                          {sos?.address_components[2]?.short_name}
                        </strong>
                      </div>
                      <div className="w-full h-16 border-2 border-dashed border-gray-400">
                        Vị trí:{" "}
                        <strong>
                          {sos?.address_components[0]?.short_name}{" "}
                          {sos?.address_components[1]?.short_name}
                        </strong>
                      </div>
                    </div>
                    <div>
                      <div
                        className={`bg-white shadow shadow-gray-500 rounded-[100%] ${
                          sizes.width > 320
                            ? "px-4 text-xs sm:text-sm py-3"
                            : "px-2  text-[10px] py-1"
                      ...
                      >
                        <Image
                          ...
                          height={24}
                        />
                        <div className="text-gray-400">Xem map</div>
                      </div>
                      {/* <div className="text-[#c80000] flex justify-between text-xs items-center mt-1">
                  Cách{" "}
                  {calculateDistance(
                  ...
                  <div
                    className={`py-3  px-0 sm:px-4 flex text-[#c80000] justify-center items-center ${
                      sizes.width > 376 ? "text-sm sm:text-base" : "text-xs"
                    }`}
                  >
                    Lỗi địa chỉ
                ...
                <>
                  <div
                    className={`mb-4 flex gap-x-2 gap-y-4 w-full px-0 sm:px-4 ${
                      sizes.width > 420
                  ...
                  >
                    <div className="w-full">
                      ...
                      helperSoss?.findIndex((x) => x.sosId === sos?.sosId) >
                        -1 ? (
                        <div className="text-[#C82027] font-medium text-sm">
                          Bạn{" "}
                          {sos?.helpers.length > 1 &&
                            `và ${sos?.helpers.length - 1} người khác`}{" "}
                          đã tiếp nhận giúp đỡ S.O.S này
                        </div>
                      ) : now.isBefore(
                          moment(
                            DateTimeLog(sos?.createdAt, sos?.deadline),
                        ...
                        <>
                          {sos?.user?.email !== user?.email && (
                            <Button
                              isProcessing={loadingSubmit}
                              color="failure"
                              className={`bg-[#D15156] w-full rounded-full ${
                                sizes.width > 450
                                  ? "[&>span]:text-sm [&>span]:sm:text-base"
                                  : `[&>span]:text-xs`
                              } p-1.5`}
                              onClick={() => {
                          ...
                          {sos?.helpers?.length > 0 ? (
                            <div className="text-[#C82027] font-medium text-sm">
                              Đã có {sos?.helpers?.length} người tiếp nhận
                            </div>
                          ) : (
                            <div className="font-medium text-sm text-[#C82027]">
                        ...
                        <div className="text-[#0F78DA] font-medium text-sm">
                          S.O.S đã hoàn thành
                        </div>
                      ) : sos?.status === 1 &&
                        sos?.helpers.length <= 0 &&
                        ...
                        <div className="text-[#5E666D] font-medium text-sm">
                          S.O.S đã hết hạn
                        </div>
                      ) : (
                        <div className="text-[#5E666D] font-medium text-sm">
                ...
                <div className="w-full h-24 border-2 border-dashed border-gray-400 py-2 px-3">
                  <div
                    className={`${
                      sizes.width > 376 ? "text-sm" : "text-xs"
                    }  leading-tight`}
                  >
                    Ghi chú khác: <br />
                    {sos?.description}
                ...
                <div>
                  {sos?.helpers?.filter(
                    (x) => x?.isCompleted && x?.isCompletedConfirm
                  ).length > 0 && (
                    <div className="border-t-2 border-gray-300 mt-3">
                      ...
                      <div className="flex w-full items-center">
                        <div
                          className={`w-[calc(100%-35px)] grid ${
                            sizes.width > 510
                              ? "grid-cols-4"
                              : sizes.width > 400
                              ? "grid-cols-3"
                          ...
                          {sos?.helpers
                            ...
                            ?.map((item, index) => {
                              return (
                                <div
                                  key={index}
                                  className="shadow shadow-gray-500 text-xs sm:text-sm p-2"
                                >
                                  <div className="text-[#c80000] font-medium">
                                    {item?.user?.name
                                      ? item?.user?.name
                                      : `Dumuc ${item?.user?.username}`}
                                  </div>
                          ...
                          <div className="flex w-full items-center">
                            ...
                            >
                              {sos?.helpers
                                ?.filter(
                                  (x) =>
                                    !x?.isCompleted && !x?.isCompletedConfirm
                                )
                                ?.map((item, index) => {
                                  return (
                                    <div
