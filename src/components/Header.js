          ...
          > 
            ...
            {user ? (
              <Link
                href={"/account"}
                className={
                  "relative inline-flex items-center justify-center w-10 h-10 overflow-hidden bg-gray-100 rounded-full text-center"
                }
              >
                {
                  user?.photoURL && user?.photoURL?.length > 0 ? <Image width={0} height={0} sizes="100vw" src={user?.photoURL} className="w-full h-full" alt="Avatar" /> : <span class="font-medium text-gray-600">
              ...
              <Link
                href={"/auth"}
                className={
                  "ml-1 flex text-gray-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm items-center justify-center text-center md:mr-0"
                }
              >
