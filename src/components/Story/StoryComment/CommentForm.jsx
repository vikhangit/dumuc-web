    ...
    <div id="comments">
      <div
        className={`flex justify-between ${
          !focusComment && !qoute && qoute?.length > 0 && "items-center"
        }`}
      >
        <Image
          width={0}
        ...
        >
                ...
                qoute.length > 0 && (
                  <div className="mb-[10px]">
                    {qoute.map((item, index) => (
                      <div
                        key={index}
                        className="bg-gray-200 flex mt-[5px] px-[10px] py-[8px] rounded-[10px]"
                      >
          ...
          <textarea
            value={body}
            onClick={() =>
              user ? setFocusComment(true) : router.push("/auth")
            }
            onChange={(e) => {
          ...
          <div className="flex justify-end gap-2">
            <label
              ...
              onClick={() =>
                user ? refImage.current.click() : router.push("/auth")
              }
            >
