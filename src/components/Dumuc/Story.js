...
const Story = () => {
  ...
  return (
    <>
      ...
      >
        {
          user && <SwiperSlide style={{
            height: 200, 
            cursor: "pointer"
          }}>
          <div className='border border-gray-400 rounded-[10px] w-full h-full relative' onClick={() => refStory?.current?.click()}>
              <Image width={0} height={0} sizes="100vw" src="https://wall.vn/wp-content/uploads/2020/04/anh-dep-viet-nam-18.jpg" alt="" className='w-full h-2/3 rounded-t-[10px]' />
