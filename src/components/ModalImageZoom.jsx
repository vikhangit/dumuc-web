...
export default function ModalImageZoom({
  openImage,
  setOpenImage,
  imageList,
  index,
    ...
    openImage && (
      ...
      >
        <div className="absolute right-0 top-0 z-[9999]">
          {imageList.length > 1 && (
            <button
              className="p-2 relative hover:bg-[#999999] pointer"
            ...
            >
              <Progress
                ...
                showInfo={false}
                strokeColor="#666666"
                className="absolute z-[999] top-0 left-0 w-full h-full custom-progress"
              />
              ...
              <svg
                ...
                strokeWidth={1}
                stroke="currentColor"
                className="relative z-[99999] w-8 h-8 text-white"
              >
                <path
                  strokeLinecap="round"
        ...
        <div
          className={`modal-image w-full sm:w-5/6 md:w-3/4 xl:w-1/2 ${
            sizes.height > 450 ? "h-full sm:h-5/6 xl:h-3/4" : "h-full"
          }  mx-auto`}
        >
